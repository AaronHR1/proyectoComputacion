...
using namespace std;
//version final//
void supermercado(int,int);
void granja(int,int);
void nuevobunker(int,int);
int main(){
	...
	do{
		...
		case 2:{
			...
			cout<<"Alberto te cuenta de un proyecto secreto que consiste en una arma biologica contra los zombies y te pide que si puedes ofrecerte a hacer el procedimiento en ti "<<endl;
			
	
			cout<<"Presiona la tecla de la accion que quieras tomar y despues presiona la tecla enter"<<endl;
	
			cout<<"1.- Decirle que no y contarselo a los demas del bunker."<<endl;
			cout<<"2.- Ofrecerte a ser parte del proyecto"<<endl;
			cout<<"3.- Decirle que el se convierta en la arma biologica mientras tu lo ayudas con el procedimiento"<<endl;                                 
			cout<<"4.- rendirse/fin del juego"<<endl;
			...
			switch(decision){
				case 1:{
					system("cls");
					cout<<"has creado una guerra civil dentro de el bunker con un bando que apoya a alberto y otro que no quiere armas biologicas el bunker se va a la quiebra y tienes que buscar uno nuevo"<<endl;
					cout<<"recibiste una bala en la guerra civil"<<endl;
					cout<<"vida -30";
					vida=vida-30;
					nuevobunker(vida,suministros);
					break;
				...
				case 2:{
					...
					do{
						...
						cout<<"Decidiste convertirte en un arma biologica, el procedimiento salio bien y ahora tu vida se a multiplicado"<<endl;
						cout<<"Presiona la tecla de la accion que quieras tomar y despues presiona la tecla enter"<<endl;

						cout<<"1.-Apoyar a las personas que buscan suministros en la granja"<<endl;
						cout<<"2.-Apoyar a las personas de el supermercado"<<endl;
						cout<<"3.-Ahora que eres poderoso no necesitas seguir las ordenes de el lider de tu bunker, revelarse"<<endl;                                 
						cout<<"4.- rendirse/fin del juego"<<endl;
						cin>>decision;
						...
						switch(decision){
							...
							case 3:{
								system("cls");
								cout<<"El poder te corrompio y convertiste el bunker en un infierno para sus habitantes"<<endl;
								cout<<"Final del tirano";
								exit(0);
				...
				case 3:{
					do{
						...
						cout<<"Alberto te explica claramente como hacer el procedimiento primero mezclas la sustancia A con la B y despues mezclas todo con la sustancia X"<<endl;
						cout<<"Presiona la tecla de la accion que quieras tomar y despues presiona la tecla enter"<<endl;

						cout<<"1.-X significa poderoso asi que solo le das a Alberto la sustancia X"<<endl;
						cout<<"2.-Seguir el procecdimiento"<<endl;
						cout<<"3.-Te arrepientes y les dices a todos lo que hacae Alberto"<<endl;                                 
						cout<<"4.- rendirse/fin del juego"<<endl;
						cin>>decision;
						...
						switch(decision){
							case 1: {
								system("cls");
								cout<<"Le das a Alberto solo la sustancia X lo convierte en un ser muy agresivo, que te lastima de gravedad ademas destruye el bunker y escapa"<<endl;
								cout<<"VIDA-50";
								vida=vida-50;
								cout<<"no te queda mas opcion que buscar un nuevo bunker"<<endl;
								nuevobunker(vida,suministros);
								exit(0);
							...
							case 2:{
								system("cls");
								cout<<"sigues el procedimiento ahora Alberto se a convertido en un super hombre, por lo que realizan el experimento en ti tambien"<<endl;
								cout<<"VIDA+200";
								vida=vida+200;
								cout<<"ahora que tienes esta fuerza puedes apoyar en la busqueda de suministros en el supermercado";
								supermercado(vida,suministros);
		...
		case 3:{
			...
			cout<<"has decidido ir solo por lo que el jefe de el bunker te proporciona un botiquin y un traje antizombie "<<endl;
			cout<<"VIDA+50"<<endl;
			
			vida=vida+50;
		
			cout<<"Ya afuera de el bunker y gracias a la privacidad de tu mente, empiezas a cuestionarte opciones mas descabelladas"<<endl;
			cout<<"Y si no hago nada? y si me quedo yo solo con los suministros que encuentre? y si voy a un bunker en mejores condiciones? o simplemente sigo el protocolo y me dirijo hacia la granja a buscar comida"<<endl;
			cout<<"Presiona la tecla de la accion que quieras tomar y despues presiona la tecla enter"<<endl;
...
void supermercado(int vida,int suministros){
	int decision =0;
